        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-primary-foreground/70">
              <li><Link to="/cursos/tecnicos-ead" className="hover:text-primary-foreground transition-colors">Cursos Técnicos EAD</Link></li>
              <li><Link to="/cursos/certificacao-por-competencia" className="hover:text-primary-foreground transition-colors">Certificação por Competência</Link></li>
              <li><Link to="/cursos/pos-tecnicos" className="hover:text-primary-foreground transition-colors">Cursos Pós-Técnicos</Link></li>
