...
const coursesData: Record<string, CourseData> = {
  ...
  "logistica": {
    ...
    subtitle: "Impulsione sua carreira em um setor crucial para o mundo moderno",
    ...
    description: "O Curso Técnico de Logística EAD forma profissionais para atuar na gestão de estoques, transporte, distribuição e cadeia de suprimentos. Com a globalização e o crescimento do e-commerce, a demanda por profissionais qualificados em logística está em alta.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12195", parecer: "243/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Logística é essencial para empresas que buscam eficiência na movimentação de mercadorias e gestão de estoques.",
    howItWorks: ["Formação completa em logística e supply chain.", "Metodologia EAD flexível com suporte especializado."],
    profession: "Atue em transportadoras, centros de distribuição, indústrias, e-commerces e operadores logísticos.",
    market: "A logística é um setor em constante crescimento, especialmente com a expansão do comércio eletrônico.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos da Logística", hours: 80 }, { name: "Gestão de Estoques", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Transporte e Distribuição", hours: 80 }, { name: "Armazenagem", hours: 60 }, { name: "Logística Reversa", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Supply Chain Management", hours: 80 }, { name: "Sistemas de Informação Logística", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "meio-ambiente": {
    ...
    subtitle: "Atue na preservação da natureza e gestão de recursos naturais",
    image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1920&h=400&fit=crop",
    description: "O Curso Técnico de Meio Ambiente EAD forma profissionais para atuar na preservação da natureza, controle da poluição, gestão de recursos naturais e licenciamento ambiental. Uma área em constante crescimento.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12196", parecer: "244/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Meio Ambiente é fundamental para empresas e órgãos públicos que buscam sustentabilidade e conformidade ambiental.",
    howItWorks: ["Formação completa em gestão ambiental.", "Metodologia EAD flexível com suporte especializado."],
    profession: "Atue em empresas, consultorias ambientais, órgãos públicos e ONGs.",
    market: "A demanda por profissionais de meio ambiente cresce com a conscientização ambiental e novas legislações.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Ecologia e Ecossistemas", hours: 80 }, { name: "Legislação Ambiental", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Gestão de Recursos Hídricos", hours: 80 }, { name: "Controle de Poluição", hours: 80 }, { name: "Resíduos Sólidos", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Licenciamento Ambiental", hours: 80 }, { name: "Educação Ambiental", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "agrimensura": {
    ...
    subtitle: "Atue com medições, levantamentos topográficos e georreferenciamento",
    image: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Agrimensura EAD forma profissionais capacitados para atuar com medições, levantamentos topográficos, georreferenciamento, mapeamento territorial e análise de dados geoespaciais utilizando tecnologias modernas como GPS, estação total, drones e softwares de geoprocessamento.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12197", parecer: "245/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Agrimensura é essencial para projetos urbanos, rurais, ambientais e de construção civil.",
    howItWorks: ["Formação completa em topografia e georreferenciamento.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de engenharia, cartórios, prefeituras, construtoras e como autônomo.",
    market: "A demanda por agrimensores cresce com o cadastro ambiental rural e regularização fundiária.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Topografia Básica", hours: 100 }, { name: "Cartografia", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Geodésia e GPS", hours: 100 }, { name: "Sensoriamento Remoto", hours: 80 }, { name: "Geoprocessamento", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Georreferenciamento de Imóveis Rurais", hours: 100 }, { name: "Legislação Agrária", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "agroindustria": {
    title: "Curso Técnico em Agroindústria EAD",
    subtitle: "Atue no processamento e controle de qualidade de alimentos",
    ...
    description: "O Curso Técnico em Agroindústria EAD forma profissionais capacitados para atuar em todas as etapas do processamento, produção e controle de qualidade de alimentos e produtos de origem vegetal e animal.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12198", parecer: "246/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Agroindústria é fundamental para a indústria de alimentos e bebidas.",
    howItWorks: ["Formação completa em tecnologia de alimentos.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em frigoríficos, laticínios, indústrias de alimentos e cooperativas.",
    market: "O setor agroindustrial brasileiro é um dos maiores do mundo com alta demanda por profissionais.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Tecnologia de Alimentos", hours: 100 }, { name: "Microbiologia", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Processamento de Carnes", hours: 80 }, { name: "Processamento de Leite", hours: 80 }, { name: "Processamento de Vegetais", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Controle de Qualidade", hours: 100 }, { name: "Boas Práticas de Fabricação", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "analises-clinicas": {
    ...
    subtitle: "Prepare-se para atuar em um dos setores mais promissores da saúde",
    ...
    description: "O Curso Técnico em Análises Clínicas EAD forma profissionais para atuar em laboratórios de análises clínicas, hospitais e clínicas, realizando coleta e processamento de amostras biológicas, exames laboratoriais e controle de qualidade.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12199", parecer: "247/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Análises Clínicas é fundamental para o diagnóstico de doenças e acompanhamento de tratamentos.",
    howItWorks: ["Formação completa em técnicas laboratoriais.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em laboratórios, hospitais, clínicas, bancos de sangue e indústrias farmacêuticas.",
    market: "O setor de saúde está em constante expansão com alta demanda por profissionais qualificados.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Bioquímica Clínica", hours: 100 }, { name: "Hematologia", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Microbiologia", hours: 100 }, { name: "Parasitologia", hours: 80 }, { name: "Uroanálise", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Imunologia", hours: 80 }, { name: "Biossegurança", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "automacao-industrial": {
    ...
    subtitle: "Especialize-se em sistemas automatizados e Indústria 4.0",
    image: "https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Automação Industrial EAD forma profissionais para programar, operar e manter sistemas automatizados. A indústria está em constante evolução e a demanda por profissionais qualificados em automação nunca foi tão alta.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12200", parecer: "248/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Automação Industrial é essencial para a modernização das indústrias.",
    howItWorks: ["Formação completa em sistemas automatizados e CLPs.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em indústrias de diversos setores, integradores de sistemas e empresas de manutenção.",
    market: "A Indústria 4.0 está gerando altíssima demanda por profissionais em automação.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Eletricidade Industrial", hours: 100 }, { name: "Eletrônica Básica", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Controladores Lógicos Programáveis", hours: 120 }, { name: "Instrumentação Industrial", hours: 80 }, { name: "Sensores e Atuadores", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Redes Industriais", hours: 80 }, { name: "Sistemas Supervisórios", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "compliance": {
    ...
    subtitle: "Atue na prevenção de riscos legais e governança corporativa",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Compliance EAD forma profissionais para atuar na prevenção de riscos legais, éticos e regulatórios em empresas. Com ênfase em boas práticas de governança corporativa e integridade organizacional.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12201", parecer: "249/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Compliance é fundamental para empresas que buscam conformidade legal e ética.",
    howItWorks: ["Formação completa em governança corporativa.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de todos os portes, consultorias e órgãos públicos.",
    market: "A demanda por profissionais de compliance cresce com novas legislações anticorrupção.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos de Compliance", hours: 80 }, { name: "Governança Corporativa", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Legislação Anticorrupção", hours: 80 }, { name: "Auditoria Interna", hours: 80 }, { name: "Gestão de Riscos", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Código de Conduta", hours: 60 }, { name: "Canal de Denúncias", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "computacao-grafica": {
    ...
    subtitle: "Transforme sua paixão por design e tecnologia em carreira de sucesso",
    image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Computação Gráfica EAD forma profissionais para atuar com design digital, animação, modelagem 3D e produção audiovisual. Uma área vibrante e inovadora com grande demanda.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12202", parecer: "250/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Computação Gráfica domina ferramentas de design, animação e produção visual.",
    howItWorks: ["Formação completa em design digital e 3D.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em agências de publicidade, estúdios de animação, games e produtoras de vídeo.",
    market: "O mercado de mídia digital está em constante expansão com alta demanda por profissionais criativos.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Design Digital", hours: 80 }, { name: "Tratamento de Imagem", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Modelagem 3D", hours: 100 }, { name: "Animação", hours: 80 }, { name: "Edição de Vídeo", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Motion Graphics", hours: 80 }, { name: "Projeto Final", hours: 100 }, { name: "Portfólio Profissional", hours: 60 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "contabilidade": {
    ...
    subtitle: "Domine os números e destaque-se no mundo financeiro",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Contabilidade EAD forma profissionais para atuar com escrituração contábil, balanços, demonstrações financeiras, cálculo de impostos e controle patrimonial. Uma área com demanda constante.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    durationRange: "6 a 12 meses",
    certification: "Registro no CRC",
    rating: 5.0,
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12203", parecer: "251/2021", approvedDate: "07/10/2021", registerWith: "Registro no CRC" },
    aboutCourse: "O Técnico em Contabilidade é essencial para empresas de todos os portes.",
    howItWorks: ["Formação completa em contabilidade e finanças.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em escritórios contábeis, empresas, bancos e como autônomo.",
    market: "A contabilidade é uma profissão tradicional com demanda constante no mercado.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Contabilidade Básica", hours: 100 }, { name: "Matemática Financeira", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Contabilidade de Custos", hours: 80 }, { name: "Contabilidade Tributária", hours: 100 }, { name: "Legislação Trabalhista", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Análise de Balanços", hours: 80 }, { name: "Contabilidade Gerencial", hours: 80 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Posso me registrar no CRC?", answer: "Sim, após a conclusão você pode solicitar registro no Conselho Regional de Contabilidade." }]
  },
  "cuidador-idosos": {
    title: "Curso Técnico em Cuidador de Idosos EAD",
    subtitle: "Profissionalize-se em uma das áreas que mais crescem no Brasil",
    image: "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Cuidador de Idosos EAD forma profissionais para oferecer cuidados completos e humanizados à pessoa idosa, abordando higiene, alimentação, medicamentos, mobilidade e suporte emocional.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12204", parecer: "252/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico Cuidador de Idosos é cada vez mais demandado com o envelhecimento da população.",
    howItWorks: ["Formação completa em cuidados geriátricos.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em residências, clínicas, hospitais e instituições de longa permanência.",
    market: "Com o envelhecimento populacional, a demanda por cuidadores qualificados cresce exponencialmente.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Anatomia e Fisiologia do Envelhecimento", hours: 80 }, { name: "Psicologia do Idoso", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Higiene e Conforto", hours: 100 }, { name: "Nutrição e Alimentação", hours: 80 }, { name: "Administração de Medicamentos", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Primeiros Socorros", hours: 80 }, { name: "Cuidados Paliativos", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "desenvolvimento-sistemas": {
    ...
    subtitle: "Transforme sua paixão por tecnologia em carreira de sucesso",
    image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Desenvolvimento de Sistemas EAD forma profissionais para criar aplicações web, mobile e desktop. O setor de TI oferece excelentes oportunidades de carreira.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12205", parecer: "253/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Desenvolvimento de Sistemas domina linguagens de programação e metodologias ágeis.",
    howItWorks: ["Formação completa em programação e desenvolvimento.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de tecnologia, startups, consultorias e como freelancer.",
    market: "O setor de TI está em constante crescimento com alta demanda por desenvolvedores.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Lógica de Programação", hours: 100 }, { name: "Banco de Dados", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Desenvolvimento Web", hours: 120 }, { name: "Desenvolvimento Mobile", hours: 100 }, { name: "Metodologias Ágeis", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Testes de Software", hours: 60 }, { name: "Projeto Integrador", hours: 100 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais linguagens vou aprender?", answer: "O curso aborda diversas linguagens como JavaScript, Python, Java e frameworks modernos." }]
  },
  "design-grafico": {
    title: "Curso Técnico em Design Gráfico EAD",
    subtitle: "Transforme criatividade em profissão",
    image: "https://images.unsplash.com/photo-1626785774625-ddcddc3445e9?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1626785774625-ddcddc3445e9?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Design Gráfico EAD forma profissionais criativos para produzir peças visuais impressas e digitais, identidade visual, diagramação e publicidade.",
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12206", parecer: "254/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Design Gráfico domina ferramentas profissionais de criação visual.",
    howItWorks: ["Formação completa em design e comunicação visual.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em agências de publicidade, editoras, empresas e como freelancer.",
    market: "O mercado criativo oferece excelentes oportunidades para designers qualificados.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos do Design", hours: 80 }, { name: "Teoria das Cores", hours: 60 }] },
      { name: "Módulo 02", subjects: [{ name: "Ilustração Digital", hours: 80 }, { name: "Edição de Imagens", hours: 80 }, { name: "Diagramação", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Identidade Visual", hours: 80 }, { name: "Projeto Final", hours: 100 }, { name: "Portfólio Profissional", hours: 60 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "eletroeletronica": {
    ...
    subtitle: "Domine circuitos elétricos e sistemas de automação",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Eletroeletrônica EAD forma profissionais para atuar com circuitos elétricos, eletrônicos, sistemas de automação e manutenção de equipamentos industriais.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12207", parecer: "255/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Eletroeletrônica combina conhecimentos de elétrica e eletrônica.",
    howItWorks: ["Formação completa em sistemas eletroeletrônicos.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em indústrias, empresas de manutenção e projetos de instalação.",
    market: "Alta demanda por profissionais qualificados em eletroeletrônica.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Eletricidade Básica", hours: 100 }, { name: "Eletrônica Analógica", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Eletrônica Digital", hours: 100 }, { name: "Microcontroladores", hours: 80 }, { name: "Instrumentação", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Automação Industrial", hours: 100 }, { name: "Manutenção de Equipamentos", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "eletronica": {
    ...
    subtitle: "Entenda como a tecnologia funciona e seja capaz de inovar",
    image: "https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Eletrônica EAD forma profissionais para criar, reparar e inovar em circuitos eletrônicos. Alta demanda por profissionais qualificados em um mercado tecnológico.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12208", parecer: "256/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Eletrônica domina circuitos analógicos, digitais e microcontroladores.",
    howItWorks: ["Formação completa em eletrônica.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em indústrias, assistências técnicas e empresas de tecnologia.",
    market: "A eletrônica está presente em todos os dispositivos modernos.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Eletricidade", hours: 80 }, { name: "Eletrônica Analógica", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Eletrônica Digital", hours: 100 }, { name: "Microcontroladores", hours: 100 }, { name: "Telecomunicações", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Projetos Eletrônicos", hours: 100 }, { name: "Manutenção de Equipamentos", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "estetica-cosmetologia": {
    ...
    subtitle: "Transforme sua paixão pela beleza em carreira de sucesso",
    image: "https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Estética e Cosmetologia EAD forma profissionais para atuar no universo da beleza com tratamentos faciais, corporais e tecnologias estéticas.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12209", parecer: "257/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Estética domina procedimentos de beleza e bem-estar.",
    howItWorks: ["Formação completa em estética facial e corporal.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em clínicas de estética, spas, salões e como autônomo.",
    market: "O mercado de beleza está em constante crescimento no Brasil.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Anatomia e Fisiologia da Pele", hours: 80 }, { name: "Cosmetologia", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Estética Facial", hours: 100 }, { name: "Estética Corporal", hours: 100 }, { name: "Eletroterapia", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Biossegurança", hours: 60 }, { name: "Gestão de Negócios", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "financas": {
    ...
    subtitle: "Atue na gestão financeira de empresas",
    image: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Finanças EAD forma profissionais para atuar na gestão financeira com foco em controle de custos, fluxo de caixa, investimentos e planejamento financeiro.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12210", parecer: "258/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Finanças é essencial para a saúde financeira das organizações.",
    howItWorks: ["Formação completa em finanças corporativas.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas, bancos, consultorias e como autônomo.",
    market: "A área financeira é valorizada em empresas de todos os portes.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Matemática Financeira", hours: 100 }, { name: "Contabilidade Básica", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Gestão de Custos", hours: 80 }, { name: "Fluxo de Caixa", hours: 80 }, { name: "Análise de Investimentos", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Planejamento Financeiro", hours: 80 }, { name: "Mercado Financeiro", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "guia-turismo": {
    ...
    subtitle: "Transforme sua paixão por viagens em carreira",
    image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Guia de Turismo EAD forma profissionais para liderar grupos, explorar destinos e compartilhar conhecimento sobre história, cultura e geografia.",
    originalPrice: "R$ 3.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1000,
    durationRange: "6 a 12 meses",
    certification: "Registro no CADASTUR",
    rating: 5.0,
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12211", parecer: "259/2021", approvedDate: "07/10/2021", registerWith: "Registro no CADASTUR" },
    aboutCourse: "O Guia de Turismo é o profissional que acompanha e orienta turistas em viagens.",
    howItWorks: ["Formação completa em turismo e hospitalidade.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em agências de viagens, operadoras e como guia autônomo.",
    market: "O turismo é um dos setores que mais emprega no mundo.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos do Turismo", hours: 80 }, { name: "Geografia Turística", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "História e Cultura", hours: 80 }, { name: "Técnicas de Guiamento", hours: 100 }, { name: "Primeiros Socorros", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Legislação Turística", hours: 60 }, { name: "Idiomas Aplicados", hours: 80 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Posso me registrar no CADASTUR?", answer: "Sim, o diploma permite registro no CADASTUR para atuação legal como guia." }]
  },
  "informatica": {
    title: "Curso Técnico em Informática EAD",
    subtitle: "Explore o universo da tecnologia",
    image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Informática EAD forma profissionais para atuar com hardware, software, redes e suporte técnico. Uma área com demanda constante.",
    originalPrice: "R$ 1.750,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12212", parecer: "260/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Informática domina hardware, software e redes.",
    howItWorks: ["Formação completa em TI.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de todos os setores que utilizam tecnologia.",
    market: "A informática é essencial em todas as organizações modernas.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Hardware", hours: 100 }, { name: "Sistemas Operacionais", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Redes de Computadores", hours: 100 }, { name: "Programação Básica", hours: 80 }, { name: "Banco de Dados", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Segurança da Informação", hours: 80 }, { name: "Suporte Técnico", hours: 80 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "informatica-internet": {
    ...
    subtitle: "Torne-se especialista em soluções digitais",
    image: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Informática para Internet EAD forma profissionais para desenvolvimento web, e-commerce e soluções digitais.",
    originalPrice: "R$ 1.750,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12213", parecer: "261/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Informática para Internet domina tecnologias web.",
    howItWorks: ["Formação completa em desenvolvimento web.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em agências digitais, startups e empresas de tecnologia.",
    market: "O mercado digital está em constante expansão.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "HTML e CSS", hours: 100 }, { name: "JavaScript", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "PHP e MySQL", hours: 100 }, { name: "Frameworks Web", hours: 80 }, { name: "UX/UI Design", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "E-commerce", hours: 60 }, { name: "Projeto Web", hours: 100 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "inteligencia-artificial": {
    ...
    subtitle: "Atue nas áreas mais promissoras da tecnologia",
    image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Inteligência Artificial EAD forma profissionais para desenvolver soluções inteligentes usando machine learning, big data e automação.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12214", parecer: "262/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em IA domina ferramentas e técnicas de aprendizado de máquina.",
    howItWorks: ["Formação em machine learning e análise de dados.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de tecnologia, startups e consultorias.",
    market: "A IA está transformando todos os setores da economia.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Projetos"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Programação Python", hours: 100 }, { name: "Estatística e Matemática", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Machine Learning", hours: 120 }, { name: "Deep Learning", hours: 100 }, { name: "Big Data", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Processamento de Linguagem Natural", hours: 80 }, { name: "Visão Computacional", hours: 80 }, { name: "Projeto Integrador", hours: 120 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Preciso saber programar?", answer: "Não é obrigatório, mas conhecimentos básicos em programação facilitam o aprendizado." }]
  },
  "manutencao-automotiva": {
    title: "Curso Técnico em Manutenção Automotiva EAD",
    subtitle: "Atue na inspeção, diagnóstico e reparo de veículos",
    image: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Manutenção Automotiva EAD forma profissionais para atuar na inspeção, diagnóstico, reparo e manutenção de veículos automotores com tecnologias modernas.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12215", parecer: "263/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Manutenção Automotiva domina sistemas mecânicos, elétricos e eletrônicos veiculares.",
    howItWorks: ["Formação completa em mecânica automotiva.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em concessionárias, oficinas e centros automotivos.",
    market: "O setor automotivo demanda constantemente profissionais qualificados.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Motores de Combustão", hours: 100 }, { name: "Sistemas de Transmissão", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Sistemas de Freios e Suspensão", hours: 100 }, { name: "Sistemas Elétricos Automotivos", hours: 100 }, { name: "Injeção Eletrônica", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Diagnóstico Eletrônico", hours: 100 }, { name: "Híbridos e Elétricos", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "manutencao-maquinas-industriais": {
    title: "Curso Técnico em Manutenção de Máquinas Industriais EAD",
    subtitle: "Atue na manutenção preventiva e corretiva de equipamentos",
    image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Manutenção de Máquinas Industriais EAD forma profissionais para atuar na instalação, operação, análise e manutenção de equipamentos industriais.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12216", parecer: "264/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Manutenção de Máquinas Industriais é essencial para a eficiência produtiva.",
    howItWorks: ["Formação completa em manutenção industrial.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em indústrias de diversos setores.",
    market: "A manutenção industrial é fundamental para a competitividade empresarial.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Mecânica Industrial", hours: 100 }, { name: "Eletricidade Industrial", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Hidráulica e Pneumática", hours: 100 }, { name: "Elementos de Máquinas", hours: 80 }, { name: "Lubrificação", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Manutenção Preventiva", hours: 100 }, { name: "Manutenção Preditiva", hours: 80 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "manutencao-suporte-informatica": {
    title: "Curso Técnico em Manutenção e Suporte em Informática EAD",
    subtitle: "Torne-se especialista em suporte técnico",
    image: "https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Manutenção e Suporte em Informática EAD forma profissionais para garantir o funcionamento de sistemas e dispositivos.",
    originalPrice: "R$ 1.750,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12217", parecer: "265/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Manutenção e Suporte domina hardware, software e redes.",
    howItWorks: ["Formação completa em suporte técnico.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas, help desks e assistências técnicas.",
    market: "O suporte em TI é essencial para todas as organizações.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Montagem e Manutenção de PCs", hours: 100 }, { name: "Sistemas Operacionais", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Redes de Computadores", hours: 100 }, { name: "Segurança da Informação", hours: 80 }, { name: "Help Desk", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Diagnóstico e Solução de Problemas", hours: 100 }, { name: "ITIL Fundamentos", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "marketing-comunicacao": {
    ...
    subtitle: "Destaque-se no mundo do marketing digital",
    image: "https://images.unsplash.com/photo-1533750349088-cd871a92f312?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1533750349088-cd871a92f312?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Marketing e Comunicação EAD forma profissionais para atuar com estratégias de marketing, publicidade e comunicação empresarial.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12218", parecer: "266/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Marketing domina estratégias de comunicação e vendas.",
    howItWorks: ["Formação completa em marketing.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em agências, empresas e como freelancer.",
    market: "O marketing é essencial para o sucesso de qualquer negócio.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos de Marketing", hours: 80 }, { name: "Comportamento do Consumidor", hours: 60 }] },
      { name: "Módulo 02", subjects: [{ name: "Marketing Digital", hours: 100 }, { name: "Redes Sociais", hours: 80 }, { name: "Publicidade e Propaganda", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Pesquisa de Mercado", hours: 60 }, { name: "Planejamento de Marketing", hours: 80 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "mineracao": {
    ...
    subtitle: "Especialize-se em um setor essencial para a economia",
    image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Mineração EAD forma profissionais para atuar em geologia, topografia de minas, técnicas de extração e segurança do trabalho em mineração.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12219", parecer: "267/2021", approvedDate: "07/10/2021", registerWith: "Registro no CREA" },
    aboutCourse: "O Técnico em Mineração é essencial para a indústria de extração mineral.",
    howItWorks: ["Formação completa em técnicas de mineração.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em mineradoras, consultorias e órgãos ambientais.",
    market: "O Brasil é um dos maiores produtores minerais do mundo.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Geologia Geral", hours: 100 }, { name: "Topografia de Minas", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Lavra a Céu Aberto", hours: 100 }, { name: "Lavra Subterrânea", hours: 80 }, { name: "Tratamento de Minérios", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Segurança em Mineração", hours: 100 }, { name: "Gestão Ambiental", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "O curso tem registro no CREA?", answer: "Sim, após a conclusão você pode solicitar registro no CREA como técnico." }]
  },
  "nutricao-dietetica": {
    ...
    subtitle: "Transforme sua paixão por saúde em carreira",
    image: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Nutrição e Dietética EAD forma profissionais para atuar em serviços de alimentação, auxiliando nutricionistas.",
    originalPrice: "R$ 1.750,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12220", parecer: "268/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Nutrição auxilia na elaboração de cardápios e controle de qualidade alimentar.",
    howItWorks: ["Formação completa em nutrição e dietética.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em hospitais, escolas, restaurantes e indústrias alimentícias.",
    market: "A preocupação com alimentação saudável cresce constantemente.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Nutrição Básica", hours: 100 }, { name: "Bromatologia", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Dietoterapia", hours: 100 }, { name: "Técnica Dietética", hours: 80 }, { name: "Higiene Alimentar", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Administração de UAN", hours: 80 }, { name: "Educação Alimentar", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "papel-celulose": {
    ...
    subtitle: "Atue na indústria de papel e celulose",
    image: "https://images.unsplash.com/photo-1530587191325-3db32d826c18?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1530587191325-3db32d826c18?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Papel e Celulose EAD forma profissionais para atuar nos processos de produção, controle de qualidade e gestão ambiental do setor.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12221", parecer: "269/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Papel e Celulose domina processos industriais do setor.",
    howItWorks: ["Formação completa em processos de papel e celulose.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em fábricas de papel, celulose e embalagens.",
    market: "O Brasil é um dos maiores produtores de celulose do mundo.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Química da Madeira", hours: 80 }, { name: "Processos de Celulose", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Fabricação de Papel", hours: 100 }, { name: "Controle de Qualidade", hours: 80 }, { name: "Instrumentação", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Tratamento de Efluentes", hours: 80 }, { name: "Gestão Ambiental", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "petroleo-gas": {
    ...
    subtitle: "Atue em todas as etapas da cadeia produtiva do setor energético",
    image: "https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Petróleo e Gás EAD forma profissionais para atuar desde a prospecção até o refino, com excelentes oportunidades de carreira.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12222", parecer: "270/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Petróleo e Gás opera processos industriais do setor energético.",
    howItWorks: ["Formação completa em petróleo e gás.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em plataformas, refinarias e distribuidoras.",
    market: "O setor de petróleo e gás oferece excelentes salários.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Geologia do Petróleo", hours: 80 }, { name: "Perfuração e Completação", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Produção de Petróleo", hours: 100 }, { name: "Processamento de Gás Natural", hours: 80 }, { name: "Refino", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Segurança Offshore", hours: 100 }, { name: "Gestão Ambiental", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "programacao-jogos-digitais": {
    title: "Curso Técnico em Programação de Jogos Digitais EAD",
    subtitle: "De jogador a criador de games",
    image: "https://images.unsplash.com/photo-1556438064-2d7646166914?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1556438064-2d7646166914?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Programação de Jogos Digitais EAD forma profissionais para criar jogos para diversas plataformas. Transforme sua paixão em profissão.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12223", parecer: "271/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Programação de Jogos domina engines e linguagens de desenvolvimento.",
    howItWorks: ["Formação completa em desenvolvimento de games.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em estúdios de games, agências e como desenvolvedor independente.",
    market: "A indústria de games é uma das que mais cresce no mundo.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Portfólio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Lógica de Programação", hours: 100 }, { name: "Game Design", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Unity 3D", hours: 120 }, { name: "Programação C#", hours: 100 }, { name: "Arte para Games", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Desenvolvimento Mobile", hours: 80 }, { name: "Projeto de Game", hours: 120 }, { name: "Publicação e Monetização", hours: 60 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Qual engine vou aprender?", answer: "O curso foca principalmente em Unity 3D, uma das engines mais usadas no mercado." }]
  },
  "protese-dentaria": {
    title: "Curso Técnico em Prótese Dentária EAD",
    subtitle: "Atue na confecção de próteses dentárias",
    image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Prótese Dentária EAD forma profissionais para confeccionar, reparar e ajustar próteses dentárias com alta empregabilidade.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12224", parecer: "272/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Prótese Dentária domina técnicas de confecção de próteses.",
    howItWorks: ["Formação completa em prótese dentária.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em laboratórios de prótese e clínicas odontológicas.",
    market: "A odontologia é uma área com demanda constante por profissionais.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Anatomia Dental", hours: 80 }, { name: "Materiais Odontológicos", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Prótese Total", hours: 100 }, { name: "Prótese Parcial Removível", hours: 100 }, { name: "Prótese Fixa", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Ortodontia", hours: 80 }, { name: "Biossegurança", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "qualidade": {
    ...
    subtitle: "Atue no controle e melhoria contínua de processos",
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Qualidade EAD forma profissionais para atuar no controle, análise e melhoria contínua de processos organizacionais.",
    originalPrice: "R$ 1.500,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12225", parecer: "273/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Qualidade domina ferramentas e metodologias de gestão da qualidade.",
    howItWorks: ["Formação completa em gestão da qualidade.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de todos os setores.",
    market: "A qualidade é fundamental para a competitividade empresarial.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos da Qualidade", hours: 80 }, { name: "Ferramentas da Qualidade", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "ISO 9001", hours: 100 }, { name: "Auditorias da Qualidade", hours: 80 }, { name: "Indicadores", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Lean e Six Sigma", hours: 100 }, { name: "Melhoria Contínua", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "quimica": {
    ...
    subtitle: "Atue em processos químicos industriais e laboratoriais",
    image: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Química EAD forma profissionais para atuar em processos químicos industriais, análises laboratoriais e controle de qualidade.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    durationRange: "6 a 12 meses",
    certification: "Registro no CRQ",
    rating: 5.0,
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12226", parecer: "274/2021", approvedDate: "07/10/2021", registerWith: "Registro no CRQ" },
    aboutCourse: "O Técnico em Química domina processos e análises químicas.",
    howItWorks: ["Formação completa em química aplicada.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em laboratórios, indústrias químicas e farmacêuticas.",
    market: "A química está presente em diversos setores da economia.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Química Geral", hours: 100 }, { name: "Química Orgânica", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Química Analítica", hours: 100 }, { name: "Físico-Química", hours: 80 }, { name: "Bioquímica", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Processos Químicos Industriais", hours: 100 }, { name: "Segurança em Laboratório", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Posso me registrar no CRQ?", answer: "Sim, após a conclusão você pode solicitar registro no Conselho Regional de Química." }]
  },
  "recursos-humanos": {
    title: "Curso Técnico em Recursos Humanos EAD",
    subtitle: "Construa uma carreira de sucesso em RH",
    image: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Recursos Humanos EAD forma profissionais para atuar em recrutamento e seleção, treinamento, gestão de benefícios e desenvolvimento de pessoas.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12227", parecer: "275/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em RH domina as rotinas e processos de gestão de pessoas.",
    howItWorks: ["Formação completa em gestão de pessoas.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de todos os portes e consultorias de RH.",
    market: "A gestão de pessoas é estratégica para o sucesso das organizações.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Gestão de Pessoas", hours: 100 }, { name: "Recrutamento e Seleção", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Treinamento e Desenvolvimento", hours: 80 }, { name: "Cargos e Salários", hours: 80 }, { name: "Legislação Trabalhista", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Gestão de Benefícios", hours: 60 }, { name: "Clima Organizacional", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "rede-computadores": {
    ...
    subtitle: "Projete, instale e gerencie redes de computadores",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Rede de Computadores EAD forma profissionais para projetar, instalar, configurar e gerenciar redes de computadores.",
    originalPrice: "R$ 1.750,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12228", parecer: "276/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Redes domina infraestrutura de TI e segurança.",
    howItWorks: ["Formação completa em redes de computadores.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de TI, provedores de internet e data centers.",
    market: "A infraestrutura de redes é essencial para todas as organizações.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Fundamentos de Redes", hours: 100 }, { name: "Cabeamento Estruturado", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Protocolos TCP/IP", hours: 100 }, { name: "Roteamento e Switching", hours: 100 }, { name: "Redes Wireless", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Segurança de Redes", hours: 80 }, { name: "Servidores", hours: 80 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "refrigeracao-climatizacao": {
    ...
    subtitle: "Domine tecnologias de refrigeração e ar condicionado",
    image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Refrigeração e Climatização EAD forma profissionais para instalar e manter sistemas de ar condicionado, refrigeradores e câmaras frigoríficas.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12229", parecer: "277/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Refrigeração domina sistemas de climatização e refrigeração.",
    howItWorks: ["Formação completa em refrigeração e climatização.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em empresas de instalação, manutenção e como autônomo.",
    market: "O setor está em constante expansão com a crescente demanda por climatização.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Termodinâmica", hours: 80 }, { name: "Ciclos de Refrigeração", hours: 100 }] },
      { name: "Módulo 02", subjects: [{ name: "Ar Condicionado Split", hours: 100 }, { name: "Refrigeração Comercial", hours: 100 }, { name: "Câmaras Frigoríficas", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Manutenção Preventiva", hours: 80 }, { name: "Normas NR-10 e NR-35", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "saude-bucal": {
    ...
    subtitle: "Atue no apoio a procedimentos odontológicos",
    image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Saúde Bucal EAD forma profissionais para atuar no apoio a procedimentos odontológicos promovendo saúde e prevenção.",
    originalPrice: "R$ 2.500,00",
    promoPrice: "R$ 1.500,00",
    installment: "R$ 125,00",
    hours: 1200,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12230", parecer: "278/2021", approvedDate: "07/10/2021", registerWith: "Registro no CRO" },
    aboutCourse: "O Técnico em Saúde Bucal auxilia o cirurgião-dentista em procedimentos.",
    howItWorks: ["Formação completa em saúde bucal.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em consultórios, clínicas e unidades de saúde.",
    market: "A odontologia é uma área com demanda constante por profissionais.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Anatomia Bucal", hours: 80 }, { name: "Materiais Odontológicos", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Radiologia Odontológica", hours: 80 }, { name: "Procedimentos Clínicos", hours: 100 }, { name: "Prevenção em Saúde Bucal", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Biossegurança", hours: 80 }, { name: "Gestão de Consultório", hours: 60 }, { name: "Estágio Supervisionado", hours: 240 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Posso me registrar no CRO?", answer: "Sim, após a conclusão você pode solicitar registro no Conselho Regional de Odontologia." }]
  },
  "secretaria-escolar": {
    title: "Curso Técnico em Secretaria Escolar EAD",
    subtitle: "Atue na organização de instituições de ensino",
    image: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Secretaria Escolar EAD forma profissionais para atuar em escolas públicas e privadas dominando rotinas administrativas e legislação educacional.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12231", parecer: "279/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Secretaria Escolar domina gestão documental e atendimento.",
    howItWorks: ["Formação completa em gestão escolar.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em escolas, secretarias de educação e instituições de ensino.",
    market: "A educação é um setor com demanda constante por profissionais.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Administração Escolar", hours: 80 }, { name: "Legislação Educacional", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Gestão de Documentos", hours: 80 }, { name: "Sistemas de Gestão Escolar", hours: 80 }, { name: "Atendimento ao Público", hours: 60 }] },
      { name: "Módulo 03", subjects: [{ name: "Redação Oficial", hours: 60 }, { name: "Eventos Escolares", hours: 60 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
  "servicos-juridicos": {
    ...
    subtitle: "Atue como auxiliar jurídico em escritórios e tribunais",
    image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1200&h=600&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1920&h=400&fit=crop",
    description: "O Curso Técnico em Serviços Jurídicos EAD forma profissionais para atuar em escritórios de advocacia, tribunais, cartórios e departamentos jurídicos.",
    originalPrice: "R$ 1.590,00",
    promoPrice: "R$ 900,00",
    installment: "R$ 75,00",
    hours: 1000,
    ...
    youtubeVideoId: "pn97Z1-ssFI",
    category: "Curso Técnico EAD",
    registration: { portaria: "SEE-PRC-2021/12232", parecer: "280/2021", approvedDate: "07/10/2021", registerWith: "Registro Profissional" },
    aboutCourse: "O Técnico em Serviços Jurídicos domina rotinas de escritórios e tribunais.",
    howItWorks: ["Formação completa em prática jurídica.", "Metodologia EAD com suporte especializado."],
    profession: "Atue em escritórios de advocacia, fóruns, cartórios e empresas.",
    market: "O setor jurídico demanda profissionais qualificados para apoio administrativo.",
    methodology: { materials: ["Video-aulas", "Apostilas", "Biblioteca digital"], services: ["Requerimento de declarações", "Histórico", "Estágio"], responseTime: "Chamados respondidos dentro de 48 horas." },
    requirements: ["Cópia do RG e do CPF", "Comprovante de Residência", "Certificado de Conclusão do Ensino Médio"],
    tutoring: "Acompanhamento do tutor pelo portal do aluno.",
    tutorAttributes: ["Apoiar os alunos na plataforma", "Orientar durante as atividades"],
    modules: [
      { name: "Módulo 01", subjects: [{ name: "Introdução ao EAD", hours: 60 }, { name: "Introdução ao Direito", hours: 80 }, { name: "Direito Civil", hours: 80 }] },
      { name: "Módulo 02", subjects: [{ name: "Direito Trabalhista", hours: 80 }, { name: "Processo Civil", hours: 80 }, { name: "Prática Jurídica", hours: 80 }] },
      { name: "Módulo 03", subjects: [{ name: "Redação Jurídica", hours: 60 }, { name: "Ética Profissional", hours: 40 }, { name: "Estágio Supervisionado", hours: 200 }] }
    ],
    access: [{ title: "Video Aulas", description: "Estude onde e quando quiser." }, { title: "Tutoria", description: "Tire suas dúvidas." }, { title: "Diploma", description: "Autorizado pelo MEC." }],
    faq: [{ question: "Quais as formas de pagamento?", answer: "Aceitamos cartão de crédito em até 12x sem juros, boleto bancário e PIX." }]
  },
